  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '1.5rem', display: 'flex', alignItems: 'center', gap: 12 }}>
        <div style={{ width: 34, height: 34, borderRadius: 8, backgroundColor: '#00e5ff', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 0 14px rgba(0,229,255,0.3)' }}>
          <span className="material-symbols-outlined" style={{ color: '#00363d', fontSize: 19, fontVariationSettings: "'FILL' 1" }}>shield</span>
        </div>
        <div>
          <h1 style={{ color: '#00E5FF', fontFamily: 'Space Grotesk', fontWeight: 700, fontSize: 19, letterSpacing: '-0.02em', lineHeight: 1 }}>
            The Arbiter
          </h1>
          <p style={{ fontFamily: 'Space Grotesk', fontWeight: 700, textTransform: 'uppercase', fontSize: '0.58rem', letterSpacing: '0.06em', color: 'rgba(186,201,204,0.5)', marginTop: 2 }}>
