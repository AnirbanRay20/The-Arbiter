...
export default function EmptyState({ onSubmit, disabled, initialContent = '' }) {
  ...
  return (
    <div style={{
      ...
      minHeight: 'calc(100vh - 56px)', // subtract topbar height
      padding: '1rem 1.5rem',
      ...
      >
        ...
        <div style={{
          ...
          border: isFocused
            ...
            : '1px solid rgba(59,73,76,0.3)',
          boxShadow: isFocused
            ? '0 4px 32px rgba(0,0,0,0.4), 0 0 24px rgba(0,229,255,0.12)'
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: 7, border: '1px solid rgba(59,73,76,0.2)',
            }}>
              {['text', 'url'].map(t => (
